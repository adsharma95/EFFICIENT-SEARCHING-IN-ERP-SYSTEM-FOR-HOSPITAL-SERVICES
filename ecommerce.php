  ...
  <div class="collapse navbar-collapse" id="bs-example-navbarcollapse-1"> 
	...
	<a href="#" class="btn btn-primary dropdown-toggle" data-toggle="dropdown">Categories<span class="caret"></span></a>
		<ul class="dropdown-menu" role="menu">
			...
			<li><a href="category.html" class="list-group-item">Anti-Biotics</a></li>          
			<li><a href="category.html" class="list-group-item">Hair Care</a></li> 
			<li class="divider"></li>              
			<li><a href="ecommerce.php">All Categories</a></li>
		</ul>      
	</li>          
...
<ul class="row">      
	...
	<div class="thumbnail">              
	<img src="image/HIMALAYA ASHVAGANDHA TABLET.jpg" alt="">             
	...
	<div class="ratings">                  
	<p class="pull-right"><a href="Product1.html#comments"></a></p>                  
	<p>                    
	...
	<div class="col-sm-4 col-md-2">            
	<div class="thumbnail">              
	<img src="image/ZANDU VIGOREX CAPSULE.jpg" alt="">              
	<div class="add-to-cart">                
	...
	<div class="col-sm-4 col-md-2">            
	<div class="thumbnail">              
	<img src="image/R89 HAIR CARE DROP.jpg" alt="">              
	<div class="add-to-cart">                
	<a href="Product.html" class="glyphicon glyphicon-plus-sign" data-toggle="tooltip" data-placement="top" title="Add to cart"></a>              
	</div>              
	<div class="caption">                
	...
	<div class="col-sm-4 col-md-2">            
	<div class="thumbnail">              
	<img src="image/CINERARIA MARITIMA EYE DROP.jpg" alt="">              
	<div class="add-to-cart">                
	<a href="Product.html" class="glyphicon glyphicon-plus-sign" data-toggle="tooltip" data-placement="top" title="Add to cart"></a>              
	</div>              
	<div class="caption">                
	...
	<div class="col-sm-4 col-md-2">            
	<div class="thumbnail">              
	<img src="image/CALCAREA PHOS 6X TABLET.jpg" alt="">              
	<div class="add-to-cart">                
	<a href="Product.html" class="glyphicon glyphicon-plus-sign" data-toggle="tooltip" data-placement="top" title="Add to cart"></a>              
	</div>              
	<div class="caption">                
	...
	<div class="col-sm-4 col-md-2">            
	<div class="thumbnail">              
	<img src="image/DIABOHERB ORAL LIQUID.jpg" alt="">              
	<div class="add-to-cart">                
	<a href="Product.html" class="glyphicon glyphicon-plus-sign" data-toggle="tooltip" data-placement="top" title="Add to cart"></a>              
	</div>              
	<div class="caption">                
	...
	<div class="col-sm-4 col-md-2">            
	<div class="thumbnail">              
	<img src="image/ALFALFA TONIC SUGAR FREE.jpg" alt="">              
	<div class="add-to-cart">                
	<a href="Product.html" class="glyphicon glyphicon-plus-sign" data-toggle="tooltip" data-placement="top" title="Add to cart"></a>              
	</div>              
	<div class="caption">                
	...
	<div class="col-sm-4 col-md-2">            
	<div class="thumbnail">              
	<img src="image/SILK N STAY MOISTURISING BODY LOTION.jpg" alt="">              
	<div class="add-to-cart">                
	<a href="Product.html" class="glyphicon glyphicon-plus-sign" data-toggle="tooltip" data-placement="top" title="Add to cart"></a>              
	</div>              
	<div class="caption">                
...
<footer class="page-footer" style="background-color: rgb(4, 36, 48); color: white; margin-top: 26px; padding: 12px 8px 8px; margin-bottom: 0px; font-size: 14px; text-align: center;">
	<div class="container">
